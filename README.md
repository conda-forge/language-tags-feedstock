...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/language-tags-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11332&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/language-tags-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `language-tags` can be installed with:

```
conda install language-tags
```

It is possible to list all of the versions of `language-tags` available on your platform with:
